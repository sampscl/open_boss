defmodule OpenBoss.Rpi4Kiosk.Display.UdevdServer do
  @moduledoc """
  udev server

  At some point, consider moving this up a level in the supervision tree
  as udev is usefull outside the context of the display
  """
  use GenServer
