defmodule OpenBossWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OpenBossWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OpenBossWeb.Gettext, "errors", msg, opts)
    end
  end
